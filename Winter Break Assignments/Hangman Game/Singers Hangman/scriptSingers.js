...
import singersList from "../Folder With Lists/singersList.js";
...
const selectWord = () => {
    const { word, hint } = singersList[Math.floor(Math.random() * singersList.length)];
    theAnswer = word;
...
const playAgainOption = () => {
    ...
    if (playAgain) {
        window.location.href = "indexSingers.html";
    } else {
