...
import wrestlersList from "../Folder With Lists/wrestlersList.js"
...
const selectWord = () => {
    const { word, hint } = wrestlersList[Math.floor(Math.random() * wrestlersList.length)];
    theAnswer = word;
...
const playAgainOption = () => {
    ...
    if (playAgain) {
        window.location.href = "indexWrestlers.html";
    } else {
