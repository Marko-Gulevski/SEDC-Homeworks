...
// Import Words
import animeList from "../Folder With Lists/animeList.js"
// Hangman Elements
...
const selectWord = () => {
    const { word, hint } = animeList[Math.floor(Math.random() * animeList.length)];
    theAnswer = word;
...
const playAgainOption = () => {
    ...
    if (playAgain) {
        window.location.href = "indexAnime.html";
    } else {
