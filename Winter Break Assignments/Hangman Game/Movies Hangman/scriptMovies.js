'use strict'
import moviesList from "../Folder With Lists/moviesList.js"
...
const selectWord = () => {
    const { word, hint } = moviesList[Math.floor(Math.random() * moviesList.length)];
    theAnswer = word;
...
const playAgainOption = () => {
    ...
    if (playAgain) {
        window.location.href = "indexMovies.html";
    } else {
