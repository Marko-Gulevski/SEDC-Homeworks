...
// Import Words
import cartoonsList from "../Folder With Lists/cartoonsList.js"
// Hangman Elements
...
const selectWord = () => {
    const { word, hint } = cartoonsList[Math.floor(Math.random() * cartoonsList.length)];
    theAnswer = word;
...
const playAgainOption = () => {
    ...
    if (playAgain) {
        window.location.href = "indexCartoons.html";
    } else {
