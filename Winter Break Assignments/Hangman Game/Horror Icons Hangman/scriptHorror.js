...
// Imported List
import horrorIconsList from "../Folder With Lists/horrorIconsList.js";
...
const selectWord = () => {
    const { word, hint } = horrorIconsList[Math.floor(Math.random() * horrorIconsList.length)];
    theAnswer = word;
...
const playAgainOption = () => {
    ...
    if (playAgain) {
        window.location.href = "indexHorror.html";
    } else {
