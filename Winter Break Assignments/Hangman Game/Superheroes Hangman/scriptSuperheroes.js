...
import superheroesList from "../Folder With Lists/superheroesList.js";
...
const selectWord = () => {
    const { word, hint } = superheroesList[Math.floor(Math.random() * superheroesList.length)];
    theAnswer = word;
...
const playAgainOption = () => {
    ...
    if (playAgain) {
        window.location.href = "indexSuperheroes.html";
    } else {
