...
import tvShowsList from "../Folder With Lists/tvShowsList.js";
...
const selectWord = () => {
    const { word, hint } = tvShowsList[Math.floor(Math.random() * tvShowsList.length)];
    theAnswer = word;
...
const playAgainOption = () => {
    ...
    if (playAgain) {
        window.location.href = "indexShows.html";
    } else {
