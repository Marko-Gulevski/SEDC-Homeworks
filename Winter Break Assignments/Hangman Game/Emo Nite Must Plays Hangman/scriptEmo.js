...
import emoNiteList from "../Folder With Lists/emoNiteList.js"
...
const selectWord = () => {
    const { word, hint } = emoNiteList[Math.floor(Math.random() * emoNiteList.length)];
    theAnswer = word;
...
const playAgainOption = () => {
    ...
    if (playAgain) {
        window.location.href = "indexEmo.html";
    } else {
